...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 safe-area-inset-bottom z-50">
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 px-4 py-3 mx-auto max-w-md">
